...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            //EJEMPLO DE ACTUALIZACIÓN DE DATOS. CAMBIAMOS EL PRECIO DEL ART1 DE 3000 a 5000
            Articulo art1 = entityManager.find(Articulo.class, 1L);
            art1.setPrecio(5000);
            entityManager.merge(art1);
            //Esto se verá reflejado en la tabla REVINFO con un nuevo num de revisión y con fecha y hora actual
            //Y en la tabla ARTICULO_AUD podemos ver el id de la nueva revisión con el tipo de revisión
            //TIPOS DE REVISION: 0-> Alta   1->Modificar   2->Baja


            //EJEMPLO DE ELIMINACIÓN DE DATOS. ELIMINAMOS EL ART2 PORQUE NO SE USA
            Articulo art2 = entityManager.find(Articulo.class, 2L);
            entityManager.remove(art2);
            //Esto se verá reflejado en la tabla REVINFO con un nuevo num de revisión y con fecha actual
            //Y en la tabla ARTICULO_AUD podemos ver el id de la nueva revisión con el tipo de revisión
            //TIPOS DE REVISION: 0-> Alta   1->Modificar   2->Baja
